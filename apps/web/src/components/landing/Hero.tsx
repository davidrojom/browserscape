...
export function Hero() {
  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="relative mx-auto grid max-w-6xl items-center gap-12 px-5 pb-20 pt-16 lg:grid-cols-[1.02fr_0.98fr] lg:gap-12 lg:pb-28 lg:pt-24">
        <div className="max-w-xl">
          ...
          <h1
            {...rise(1)}
            className="hero-rise mt-5 text-[2.6rem] font-semibold leading-[1.04] tracking-[-0.02em] sm:text-5xl lg:text-[3.5rem]"
          >
          ...
          <p
            {...rise(2)}
            className="hero-rise mt-5 max-w-[48ch] text-lg leading-relaxed text-muted"
          >
